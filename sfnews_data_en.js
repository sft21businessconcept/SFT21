const sfNews = [ 
    ...
    },
    {
        ...
        contentHTML: `
            ...
            <blockquote class="border-l-4 border-purple-500 pl-6 my-10 bg-gray-800 bg-opacity-30 p-6 rounded-r-lg">
                <p class="text-xl font-bold text-white italic">
                    And that is why today, with immense pleasure and pride, we introduce to you our new President for Global Development of the SFT21 company – Dr. Pierre Hughes Ngatchou, known to the world and his people as Dr. Waka Waka or Prof. Pierre!
                </p>
            </blockquote>
            ...
            <h4 class="text-2xl font-bold text-fluorescent-green mt-8 mb-4">Who is Dr. Pierre Hughes Ngatchou, popularly known as Dr. Waka Waka or Prof. Pierre?</h4>
            ...
            <p class="text-gray-300 leading-relaxed text-justify mb-6">When we speak of Prof. Pierre, we are not talking about a director who runs a business from a comfortable leather armchair. We are talking about a man who paid for his vision with blood, sweat, and his own health. He is a man of the field. Over the past ten years, he has faced persecution and unjust arrests by those who do not favor a free and educated populace. But nothing stopped him. Every blow only made him stronger.</p>            
            ...
            <p class="text-gray-300 leading-relaxed text-justify mb-6">Prof. Pierre recognized that his lifelong work, his desire for the economic empowerment of the common man, and his fight for justice are now acquiring the ultimate technological tool. He recognized our business model – connecting small domestic producers, merchants, and consumers – as the perfect ecosystem in the fight against large corporations.</p>


            <p class="text-gray-300 leading-relaxed text-justify mb-6">However, this partnership is not one-sided. It's not just that Dr. Waka Waka came to us – <b>we, as SFT21, are becoming the operational foundation of his global mission</b>. To prove this, Prof. Pierre made a move that will permanently cement our unity.</p>
    ...
    },
    {
        ...
        contentHTML: `
            ...
            <div class="text-center mb-12">
                <img src="img/gloria&wakawaka.jpg" alt="Dr. Waka Waka and Gloria" class="mx-auto max-h-100 w-auto object-contain rounded-lg shadow-lg">
            </div>
            ...
            <div style="position: relative; width: 100%; margin: 2rem auto;">
                <div id="waka-gallery-1" style="display: flex; overflow-x: auto; gap: 16px; scroll-behavior: smooth; padding-bottom: 10px; scrollbar-width: none; -ms-overflow-style: none;">
                    ...
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint1.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 1" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint2.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 2" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint3.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 3" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint4.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 4" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint5.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 5" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint6.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 6" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint7.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 7" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint8.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 8" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint9.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 9" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint10.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 10" onclick="openModal(this.src)">
                    </div>
                    <div style="flex: 0 0 85%; max-width: 350px; height: 250px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.2); background: rgba(0,0,0,0.5); overflow: hidden;">
                        <img src="img/wakaint11.jpg" style="width: 100%; height: 100%; object-fit: cover; cursor: pointer;" alt="Image 11" onclick="openModal(this.src)">
                    </div>
                </div>
